...
Para fins de composição do arquivo resultado.txt, o item "('', 1186)", relativo a espaço, que aparece na oitava posição foi descartado entre as 10 palavras mais usadas no livro.

[Github de Referência do Desafio de Projeto](https://github.com/marcelomarques05/dio-desafio-dataproc)

by ericscunha@hotmail.com
